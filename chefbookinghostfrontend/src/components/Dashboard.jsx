        ...
        <div className={style.boxes}>
          <Link to="/chefs" className={style.link}>
            <div className={style.data}>
              <img style={{width:"90px"}} src="http://localhost:3001/pic_chef.png" alt="Chef" />
              <span>{noOfChef} Chefs</span>
            </div>
          </Link>
          <Link to="/bookings" className={style.link}>
            <div className={style.data}>
              <img className={style.dataimg} src="http://localhost:3001/bookingpic.png" alt="Booking" />
              <span>{noOfBooking} Booking</span>
            </div>
          </Link>
          <Link to="/users" className={style.link}>
            <div className={style.data}>
              <img className={style.dataimg} src="http://localhost:3001/defaultpic.png" alt="User" />
