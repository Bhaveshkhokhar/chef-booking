      ...
      <div style={{ margin: "5px" }}>
        <div className={style.boxes}>
          <div className={style.data}>
            <img src="http://localhost:3001/money.webp" alt="Money" />
            <span>₹ {money} </span>
          </div>
          <div className={style.data}>
            <img src="http://localhost:3001/completed.png" alt="Completed" />
            <span>{completed} Booking</span>
          </div>
          <div className={style.data}>
            <img src="http://localhost:3001/pending.png" alt="Pending" />
